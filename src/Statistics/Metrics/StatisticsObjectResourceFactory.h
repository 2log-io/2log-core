...
#ifndef METRICSOBJECTRESOURCEFACTORY_H
#define METRICSOBJECTRESOURCEFACTORY_H

#include <QObject>
#include "Server/Resources/ResourceManager/IResourceFactory.h"

class StatisticsObjectResourceFactory : public IResourceFactory
{
    Q_OBJECT

public:
    explicit StatisticsObjectResourceFactory(QObject *parent = nullptr);
    virtual ~StatisticsObjectResourceFactory() override;
...
#endif // METRICSOBJECTRESOURCEFACTORY_H
