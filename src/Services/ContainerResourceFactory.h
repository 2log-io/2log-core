...
#ifndef PERMISSIONRESOURCEFACTORY_H
#define PERMISSIONRESOURCEFACTORY_H

#include <QObject>
#include "Server/Resources/ResourceManager/IResourceFactory.h"


class ContainerResourceFactory : public IResourceFactory
{
    Q_OBJECT

public:
    ContainerResourceFactory(QString collection, QString fieldName, QObject* parent = nullptr);

    virtual ~ContainerResourceFactory() override;
...
#endif // PERMISSIONRESOURCEFACTORY_H
