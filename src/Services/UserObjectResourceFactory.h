...
#ifndef USEROBJECTRESOURCEFACTORY_H
#define USEROBJECTRESOURCEFACTORY_H

#include <QObject>
#include "Server/Resources/ResourceManager/IResourceFactory.h"

class UserObjectResourceFactory : public IResourceFactory
{
    Q_OBJECT

public:
    explicit UserObjectResourceFactory(QObject *parent = nullptr);
    virtual ~UserObjectResourceFactory() override;
...
#endif // USEROBJECTRESOURCEFACTORY_H
