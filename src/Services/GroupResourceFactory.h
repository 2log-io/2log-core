...
#ifndef GROUPRESOURCEFACTORY_H
#define GROUPRESOURCEFACTORY_H

#include <QObject>
#include "Server/Resources/ResourceManager/IResourceFactory.h"


class GroupResourceFactory : public IResourceFactory
{
    Q_OBJECT

public:
    explicit GroupResourceFactory(QObject *parent = nullptr);
