...
#ifndef USERRESOURCEFACTORY_H
#define USERRESOURCEFACTORY_H

#include <QObject>
#include "Server/Resources/ResourceManager/IResourceFactory.h"


class UserResourceFactory : public IResourceFactory
{
public:
    UserResourceFactory(QObject* parent = nullptr);

    virtual ~UserResourceFactory() override;
